...
<StorybookEmbed
  storyId="components-cardgroup--with-background-and-tag"
  height={400}
  showToolbar={false}
  title="CardGroup - Fundo e Tag"
/>
...
<StorybookEmbed
  storyId="components-cardgroup--without-tag"
  height={370}
  showToolbar={false}
  title="CardGroup - Sem Tag"
/>
...
<StorybookEmbed
  storyId="components-cardgroup--with-background-without-alert"
  height={350}
  showToolbar={false}
  title="CardGroup - Fundo sem alerta"
/>
...
<StorybookEmbed
  storyId="components-cardgroup--without-background"
  height={350}
  showToolbar={false}
  title="CardGroup - Sem Background"
/>
