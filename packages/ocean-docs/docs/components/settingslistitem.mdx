...
<StorybookEmbed
  storyId="components-settingslistitem--usage"
  height={700}
...
Para documentação técnica detalhada, exemplos de uso e API completa, consulte o **[Storybook do SettingsListItem](https://ocean-ds.github.io/ocean-web/?path=/docs/components-settingslistitem--docs)**.
...
<StorybookEmbed
  storyId="components-settingslistitem--states"
  height={600}
  showToolbar={false}
...
<StorybookEmbed
  storyId="components-settingslistitem--quickexamples"
  height={600}
  showToolbar={false}
...
- [Storybook - SettingsListItem](https://ocean-ds.github.io/ocean-web/?path=/docs/components-settingslistitem--docs) - Documentação técnica completa
