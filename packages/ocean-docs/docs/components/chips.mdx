...
O painel multiChoice se adapta ao número de opções: entre 6 e 10 itens ele cria duas colunas, a partir de 11 opções ele passa para três colunas para manter a lista compacta.

<StorybookEmbed
  storyId="components-chips--multi-choice-two-columns"
  height={400}
  showToolbar={false}
  title="Chips - Seleção múltipla em 2 colunas"
/>

<StorybookEmbed
  storyId="components-chips--multi-choice-three-columns"
  height={400}
  showToolbar={false}
  title="Chips - Seleção múltipla em 3 colunas"
/>
