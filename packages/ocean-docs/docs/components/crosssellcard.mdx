...
```css
.ods-cross-sell-card                /* Classe base */
/* Classe base */
.ods-cross-sell-card__content       /* Container do conteúdo */
.ods-cross-sell-card__information   /* Container de título e descrição */
.ods-cross-sell-card__title         /* Título do card */
.ods-cross-sell-card__description   /* Descrição do card */
.ods-cross-sell-card__image         /* Imagem do card */
