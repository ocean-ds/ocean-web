...
<div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
  <CardListReadOnly title="Saldo disponível" description="R$ 1.250,00" />
...
```tsx live
<CardListReadOnly title="Carregando..." description="Aguarde" loading />
```
...
```tsx live
<List>
  <CardListReadOnly title="Marca" description="Apple" />
  <CardListReadOnly title="Modelo" description="iPhone 14 Pro" />
  <CardListReadOnly title="Cor" description="Azul Pacífico" />
  <CardListReadOnly title="Armazenamento" description="256GB" />
  <CardListReadOnly
    title="Status"
