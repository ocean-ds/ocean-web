...
```tsx live
<Button variant="textTertiaryWarning">Texto de aviso</Button>
```
...
- **textTertiaryWarning**: Para ações de aviso discretas estilo link
...
| ----------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | -------------------------------------------- |
| `variant`   | `'primary' \| 'primaryCritical' \| 'primaryWarning' \| 'secondary' \| 'secondaryCritical' \| 'secondaryWarning' \| 'tertiary' \| 'tertiaryCritical' \| 'tertiaryWarning' \| 'textTertiary' \| 'textTertiaryCritical' \| 'textTertiaryWarning' \| 'inverse'` | `'primary'` | Define o estilo visual do botão              |
...
| `.ods-btn--text-tertiary-warning`  | Define estilos do botão text tertiary warning      |
...
- [ContextualMenu](/components/contextualmenu) - Menu contextual acionado por botão
