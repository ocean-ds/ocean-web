...
Para documentação técnica detalhada, exemplos de uso e API completa, consulte o **[Storybook do Input](https://ocean-ds.github.io/ocean-web/?path=/docs/components-input--docs)**.
...
<StorybookEmbed
  storyId="components-input--types"
  height={750}
  showToolbar={false}
...
<StorybookEmbed
  storyId="components-input--with-icons"
  height={500}
  showToolbar={false}
...
<StorybookEmbed
  storyId="components-input--currency"
  height={500}
  showToolbar={false}
...
<StorybookEmbed
  storyId="components-input--with-tooltip"
  height={400}
  showToolbar={false}
...
<StorybookEmbed
  storyId="components-input--form-example"
  height={550}
  showToolbar={false}
...
<StorybookEmbed
  storyId="components-input--special-cases"
  height={500}
  showToolbar={false}
...
- [Storybook - Input](https://ocean-ds.github.io/ocean-web/?path=/docs/components-input--docs) - Documentação técnica completa
