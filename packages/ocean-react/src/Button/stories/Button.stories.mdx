    ...
    <tr>
      ...
      <td>
        <code>
          ...
          "text" | "textCritical" | "textTertiary" | "textTertiaryCritical" |
          "inverse"
        </code>
      </td>
      <td>
      ...
      <td>
        ...
        para alternativas e text para ações sutis.
      </td>
    </tr>
    <tr>
      <td>size</td>
...
- `text`: Para ações sutis e links (referente ao tertiary no handoff)
- `textCritical`: Para ações de texto destrutivas (referente ao tertiaryCritical no handoff)
...
<Canvas withSource="open" withToolbar>
  <Story name="variants">
    ...
    >
      ...
      <Button variant="text">Text - Tertiary</Button>
      <Button variant="textCritical">Text Critical - Tertiary Critical</Button>
...
- Use `text` para ações sutis ou links
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        <code>.ods-btn--text</code>
      </td>
      <td>Define estilos do botão text.</td>
    </tr>
    <tr>
      <td>
        <code>.ods-btn--text-critical</code>
      </td>
      <td>Define estilos do botão text critical.</td>
    </tr>
    <tr>
      <td>
